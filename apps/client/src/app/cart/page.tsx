    ...
    <div className="flex flex-col gap-8 items-center justify-center mt-12">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
        {steps.map((step) => (
          ...
          >
            <div
              className={`not-odd:w-6 h-6 rounded-full text-white p-4 flex items-center justify-center ${step.id === activeStep ? "bg-gray-800" : "bg-gray-400"}`}
            >
              {step.id}
            </div>
